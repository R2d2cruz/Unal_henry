...
class ReadDataBase:
    ...
    def students(self) -> list:
        return list(self.__studentsData.keys())

    # devuelve el listado de codigos de las materias
    @property
    def matters(self) -> list:
        return list(self.__mattersData.keys())
